...
function draw() {
    ...
    if (visibilitySwitched) {
        ctx.beginPath();
        ctx.fillRect(3/4*canvas.width-0.0075*circsize*canvas.height, 1/2*canvas.height-0.01*circsize*canvas.height, 0.015*circsize*canvas.height, 0.02*circsize*canvas.height);
    } else {
        ctx.beginPath();
        ctx.fillRect(1/3*canvas.width-0.0075*circsize*canvas.height, 3/4*canvas.height-0.01*circsize*canvas.height, 0.015*circsize*canvas.height, 0.02*circsize*canvas.height);
        
        ctx.beginPath();
        ctx.arc(1/3*canvas.width, 3/4*canvas.height-distance/100*canvas.width, 0.005*circsize*canvas.height, 0, 2*Math.PI);
        ctx.fill();
    }
}
